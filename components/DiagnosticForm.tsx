...
import {
  INDUSTRY_PRESETS,
  runDiagnosticEngine
} from '../src/data/diagnosticBenchmarks';
...
export const DiagnosticForm: React.FC = () => {
  ...
  const handleInputChange = (
    field: keyof CampaignMetricsInput,
    value: string
  ) => {
    setActivePreset('');
  ...
  const handleCopyReport = () => {
    let text =
      `📊 DIAGNÓSTICO DA CAMPANHA - AS META ADS PRO\n`;
    ...
    text += `${report.diagnosticoTexto}\n\n`;

    text += `--- PRÓXIMA AÇÃO RECOMENDADA ---\n`;
    text += `${report.proximaAcaoRecomendada}\n\n`;

    text += `--- NÍVEL DE CONFIANÇA DO DIAGNÓSTICO ---\n`;
    text += `${report.nivelConfianca}: ${report.justificativaConfianca}\n`;
  ...
  const hasData =
    typeof formValues.investimento === 'number' &&
    formValues.investimento > 0;
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="max-w-2xl space-y-2">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              Insira os dados reais extraídos do seu Gerenciador de Anúncios.
              A ferramenta calculará com precisão matemática as métricas
              essenciais e apresentará um diagnóstico técnico baseado em
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-4 border-b border-[#222638]">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Preencha os valores acumulados do período analisado
              (ex: últimos 7 ou 14 dias).
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="space-y-1.5 bg-[#161824] p-4 rounded-xl border border-[#252a3d] focus-within:border-amber-400 transition-colors">
            ...
            <div className="relative">
              ...
              <div className="absolute left-3 top-2.5 text-slate-500 font-bold text-sm">
                R$
              </div>
            ...
            <p className="text-[11px] text-slate-400">
              Total gasto em anúncios no período.
            </p>
          ...
          <div className="space-y-1.5 bg-[#161824] p-4 rounded-xl border border-[#252a3d] focus-within:border-amber-400 transition-colors">
            ...
            <p className="text-[11px] text-slate-400">
              Cliques reais direcionando para a página.
            </p>
          ...
          <div className="space-y-1.5 bg-[#161824] p-4 rounded-xl border border-[#252a3d] focus-within:border-amber-400 transition-colors">
            ...
            <p className="text-[11px] text-slate-400">
              Número de vendas, cadastros ou mensagens.
            </p>
          ...
          <div className="space-y-1.5 bg-[#161824] p-4 rounded-xl border border-[#252a3d] focus-within:border-amber-400 transition-colors">
            ...
            <p className="text-[11px] text-slate-400">
              Receita bruta das conversões no período.
            </p>
        ...
        {!hasData ? (
          <div className="p-8 sm:p-12 text-center bg-[#11131a] rounded-2xl border border-[#222638] text-slate-400 space-y-3">
            ...
            <h4 className="font-syne text-base font-bold text-white">
              Aguardando inserção de dados
            </h4>

            <p className="text-sm max-w-md mx-auto text-slate-400">
              Preencha os campos de Investimento, Impressões,
              Alcance, Cliques, Compras e Faturamento para visualizar
              os cálculos exatos de CPM, CTR, CPC, Frequência, CPA e ROAS.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-[#18140c] via-[#1f1b10] to-[#120f09] p-6 sm:p-7 rounded-2xl border border-amber-500/40 shadow-xl space-y-4 relative overflow-hidden">
            ...
            <div className="text-xs text-slate-400 leading-relaxed space-y-2 pt-1">
              ...
              <p>
                <strong>Nota Metodológica:</strong> As classificações de referência
                (BOM / ATENÇÃO / CRÍTICO) servem como diretrizes estimadas de
                mercado para o Meta Ads e não devem ser interpretadas como regras
                universais absolutas. O desempenho ideal varia conforme seu nicho,
                ticket médio, objetivo de campanha e margem operacional.
              </p>
